    ...
    <div className="container mx-auto px-4">
      <div className="flex flex-wrap">
        <div className="w-full lg:w-6/12 px-4">
          ...
          <div className="my-6 grid grid-cols-6 md:flex md:space-x-2">
            <a href="mailto:bnademoverflow@pm.me" target="_blank">
              <button
                className="bg-white text-gray-900 shadow-lg font-normal h-10 w-10 items-center justify-center align-center rounded-full outline-none focus:outline-none p-1 mb-2 md:mb-0"
                type="button"
              >
